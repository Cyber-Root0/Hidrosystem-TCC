...
public class AlertDialogLayout extends C0767ao {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: a */
    private void m3306a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m3307c(View view) {
        int j = C0388q.m1663j(view);
        if (j > 0) {
            return j;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m3307c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: c */
    private boolean m3308c(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0526a.C0532f.topPanel) {
                    view = childAt;
                } else if (id == C0526a.C0532f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0526a.C0532f.contentPanel && id != C0526a.C0532f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m3309d(childCount, i8);
        return true;
    }

    /* renamed from: d */
    private void m3309d(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0767ao.C0768a aVar = (C0767ao.C0768a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            android.support.v7.widget.ao$a r15 = (android.support.p020v7.widget.C0767ao.C0768a) r15
            int r2 = r15.f2538h
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = android.support.p005v4.p017i.C0388q.m1658e(r17)
            int r2 = android.support.p005v4.p017i.C0370d.m1575a(r2, r3)
            r2 = r2 & 7
            r3 = 1
        ...
        L_0x00bd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p020v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
